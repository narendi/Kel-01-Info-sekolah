  ...
  return (
    <div className="container mx-auto">
      <div className="justify-start pt-6 pl-9 pb-6 flex pr-7">
        <div className="font-bold font-serif pr-5 text-xl">Jurusan</div>
        <div>
          <button
                ...
                <td className="px-2 py-4 text-sm border-b">
                  <div className="flex justify-center">
                    <button
                      ...
                      onClick={() => BukaupdateModal(jurusan)}
                    >
                      <BsPencilSquare />
                    </button>
                    <div className="pl-3">
          ...
          <div className="fixed z-10 inset-0 overflow-y-auto">
            <div className="flex items-center justify-center min-h-screen">
              <div className="bg-white w-1/2 p-6 rounded-lg">
                ...
                <h1 className="text-2xl font-bold mb-4">Update Jurusan</h1>
